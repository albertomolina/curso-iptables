...
iptables -A FORWARD -i virbr1 -o wlan0 -s 192.168.100.0/24 \
-d 1.1.1.1/32 -p udp --dport 53 -m state --state NEW,ESTABLISHED -j ACCEPT
iptables -A FORWARD -o virbr1 -i wlan0 -d 192.168.100.0/24 \
-s 1.1.1.1/32 -p udp --sport 53 -m state --state ESTABLISHED -j ACCEPT
